function addTask() {
    ...
    taskDivText.classList.add("col-lg-6", "mx-auto", "fw-bold");
    taskDivPriority.classList.add("col-lg-1", "mx-auto", "text-center", "fw-bold");
    ...
    taskDivBtn.addEventListener("click", function() {
      taskDiv.style.textDecoration = "line-through"; // Marks task as completed
